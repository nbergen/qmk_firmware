...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT_d_warp( \
        ...
        _______, _______, KC_MU,   _______, _______, KC_PSCR,           _______, _______, KC_UP,   _______,  _______, _______, \
        _______, KC_ML,   KC_MD,   KC_MR,   _______, _______,           _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, \
